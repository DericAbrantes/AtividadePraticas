...
class CarrosselState extends State<Carrossel> {
  ...
  /* List<String> imagens = [
    'assets/img/LosCaracoles.jpg',
    'assets/img/GlaciarPeritoMoreno.jpg',
    'assets/img/VinaDelMar.jpg',
    'assets/img/PuertoVaras.jpg',
  ];*/
  ...
  InkWell imagem() => InkWell(
        ...
        onTap: () {
          Navigator.pushNamed(context, Descricao.caminho,
